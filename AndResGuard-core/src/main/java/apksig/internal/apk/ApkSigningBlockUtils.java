...
import static apksig.Constants.OID_RSA_ENCRYPTION;
import static apksig.internal.apk.ContentDigestAlgorithm.CHUNKED_SHA256;
import static apksig.internal.apk.ContentDigestAlgorithm.CHUNKED_SHA512;
import static apksig.internal.apk.ContentDigestAlgorithm.VERITY_CHUNKED_SHA256;
...
import apksig.internal.asn1.Asn1BerParser;
import apksig.internal.asn1.Asn1DecodingException;
import apksig.internal.asn1.Asn1DerEncoder;
import apksig.internal.asn1.Asn1EncodingException;
import apksig.internal.asn1.Asn1OpaqueObject;
import apksig.internal.pkcs7.AlgorithmIdentifier;
import apksig.internal.pkcs7.ContentInfo;
import apksig.internal.pkcs7.EncapsulatedContentInfo;
import apksig.internal.pkcs7.IssuerAndSerialNumber;
import apksig.internal.pkcs7.Pkcs7Constants;
import apksig.internal.pkcs7.SignedData;
import apksig.internal.pkcs7.SignerIdentifier;
import apksig.internal.pkcs7.SignerInfo;
import apksig.internal.util.ByteBufferDataSource;
import apksig.internal.util.ChainedDataSource;
import apksig.internal.util.GuaranteedEncodedFormX509Certificate;
import apksig.internal.util.Pair;
import apksig.internal.util.VerityTreeBuilder;
import apksig.internal.util.X509CertificateUtils;
import apksig.internal.x509.RSAPublicKey;
import apksig.internal.x509.SubjectPublicKeyInfo;
import apksig.internal.zip.ZipUtils;
...
public class ApkSigningBlockUtils {
    ...
    public static ByteBuffer findApkSignatureSchemeBlock(
        ...
        } catch (apksig.internal.apk.SignatureNotFoundException e) {
