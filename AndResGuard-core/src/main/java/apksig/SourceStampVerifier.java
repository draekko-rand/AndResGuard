...
import static apksig.Constants.VERSION_APK_SIGNATURE_SCHEME_V2;
import static apksig.Constants.VERSION_APK_SIGNATURE_SCHEME_V3;
import static apksig.Constants.VERSION_JAR_SIGNATURE_SCHEME;
import static apksig.apk.ApkUtilsLite.computeSha256DigestBytes;
import static apksig.internal.apk.stamp.SourceStampConstants.SOURCE_STAMP_CERTIFICATE_HASH_ZIP_ENTRY_NAME;
import static apksig.internal.apk.v1.V1SchemeConstants.MANIFEST_ENTRY_NAME;

import apksig.apk.ApkFormatException;
import apksig.apk.ApkUtilsLite;
import apksig.internal.apk.ApkSigResult;
import apksig.internal.apk.ApkSignerInfo;
import apksig.internal.apk.ApkSigningBlockUtilsLite;
...
import apksig.internal.apk.SignatureNotFoundException;
import apksig.internal.apk.stamp.SourceStampConstants;
import apksig.internal.apk.stamp.V2SourceStampVerifier;
import apksig.internal.apk.v2.V2SchemeConstants;
